    ...
    */
    ...
    for (uint i = 0; i < _tokens.length; i++) {
      /*
        ...
        the porcent needs to be between 1 and 100.
      */
      require(_porcents[i] >= 1 && _porcents[i] <= 100, "Something between 1 and 100");
      ...
      IUniswapV2Router02(UniswapRouter).swapExactETHForTokens{value: msg.value.mul(_porcents[i]).div(100)}
